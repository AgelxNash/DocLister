...
class onetableDocLister extends DocLister
{
    ...
    {
        $this->masterAlias = !empty($this->masterAlias) ? $this->masterAlias : $this->getCFGDef('masterAlias', 'c');
        $this->masterIdField =  !empty($this->masterIdField) ? $this->masterIdField : $this->getCFGDef('masterIdField', 'id');
        $this->masterParentField =  !empty($this->masterIdField) ? $this->masterIdField : $this->getCFGDef('masterParentField', 'parent');
        if ($table = $this->getCFGDef('masterTable')) {
            $this->masterTable =  !empty($this->masterTable) ? $this->getTable($this->masterTable, $this->masterAlias) : $this->getTable($table, $this->masterAlias);
        };
    ...
    {
        return parent::getCFGDef($name, $def); // TODO: Change the autogenerated stub
    }
