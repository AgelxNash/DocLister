...
!function (a) {
    ...
    function e(a, e, f, g) {
        if (X.isFile(a) && d(f)) {
            ...
            S(h, L, function j(b) {
                var d = b.type;
                "progress" == d ? c(a, e, b, b.target.result, {loaded: b.loaded, total: b.total}) : "loadend" == d ? (T(h, L, j), h = null) : c(a, e, b, b.target.result)
            });
            try {
    ...
    function f(a, b) {
        if (!a.type && 0 === a.size % 4096 && a.size <= 102400)if (u)try {
            var c = new u;
            U(c, L, function (a) {
                var d = "error" != a.type;
                b(d), d && c.abort()
    ...
    var m = 1, n = function () {
        ...
        if (a) {
            var d = X.uid(a);
            J[d] || (J[d] = {}), Q(b.split(/\s+/), function (b) {
                x ? x.event.add(a, b, c) : (J[d][b] || (J[d][b] = []), J[d][b].push(c), a.addEventListener ? a.addEventListener(b, c, !1) : a.attachEvent ? a.attachEvent("on" + b, c) : a["on" + b] = c)
            })
        }
    }, T = function (a, b, c) {
        if (a) {
            ...
            Q(b.split(/\s+/), function (b) {
                if (x)x.event.remove(a, b, c); else {
                    for (var d = e[b] || [], f = d.length; f--;)if (d[f] === c) {
                        d.splice(f, 1);
                        break
                    }
    ...
    }, X = {version: "2.0.2", cors: !1, html5: !0, media: !1, formData: !0, debug: !1, pingUrl: !1, multiFlash: !1, flashAbortTimeout: 0, withCredentials: !0, staticPath: "./dist/", flashUrl: 0, flashImageUrl: 0, postNameConcat: function (a, b) {
        return a + (null != b ? "[" + b + "]" : "")
    }, ext2mime: {jpg: "image/jpeg", tif: "image/tiff", txt: "text/plain"}, accept: {"image/*": "art bm bmp dwg dxf cbr cbz fif fpx gif ico iefs jfif jpe jpeg jpg jps jut mcf nap nif pbm pcx pgm pict pm png pnm qif qtif ras rast rf rp svf tga tif tiff xbm xbm xpm xwd", "audio/*": "m4a flac aac rm mpa wav wma ogg mp3 mp2 m3u mod amf dmf dsm far gdm imf it m15 med okt s3m stm sfx ult uni xm sid ac3 dts cue aif aiff wpl ape mac mpc mpp shn wv nsf spc gym adplug adx dsp adp ymf ast afc hps xs", "video/*": "m4v 3gp nsv ts ty strm rm rmvb m3u ifo mov qt divx xvid bivx vob nrg img iso pva wmv asf asx ogm m2v avi bin dat dvr-ms mpg mpeg mp4 mkv avc vp3 svq3 nuv viv dv fli flv wpl"}, chunkSize: 0, chunkUploadRetry: 0, chunkNetworkDownRetryTimeout: 2e3, KB: I(1), MB: I(2), GB: I(3), TB: I(4), expando: "fileapi" + (new Date).getTime(), uid: function (a) {
        ...
        return b
    }, isArray: P, support: {dnd: z && "ondrop"in o.createElement("div"), cors: z, html5: y, chunked: A, dataURI: !0, accept: W("accept"), multiple: W("multiple")}, event: {on: S, off: T, one: U, fix: V}, throttle: function (b, c) {
        var d, e;
        return function () {
        ...
        return f
    }, each: Q, afor: function (a, b) {
        var c = 0, d = a.length;
        P(a) && d-- ? !function e() {
            b(d != c && e, a[c], c++)
        }() : b(!1)
    }, extend: R, isFile: function (a) {
        ...
        if (X.isFile(a))if (r) {
            ...
            "load" == b.type ? X.readAsImage(b.result, d, e) : (e || "error" == b.type) && c(a, d, b, null, {loaded: b.loaded, total: b.total})
        ...
        a = R({prepare: X.F, beforeupload: X.F, upload: X.F, fileupload: X.F, fileprogress: X.F, filecomplete: X.F, progress: X.F, complete: X.F, pause: X.F, imageOriginal: !0, chunkSize: X.chunkSize, chunkUpoloadRetry: X.chunkUploadRetry}, a), a.imageAutoOrientation && !a.imageTransform && (a.imageTransform = {rotate: "auto"});
        ...
        return Q(d, function (a) {
            ...
            c.filesLeft = d.length, k && k.name === X.expando && (k = null, X.log("[warn] FileAPI.upload() — called without files")), ("abort" != c.statusText || c.current) && j ? (h = !1, c.currentFile = k, k && a.prepare(k, m), e._getFormData(m, j, function (h) {
                g || a.upload(c, a);
                var i = new X.XHR(R({}, m, {upload: k ? function () {
                    a.fileupload(k, i, m)
                } : n, progress: k ? function (b) {
                    l || (a.fileprogress({type: "progress", total: j.total = b.total, loaded: j.loaded = b.loaded}, k, i, m), a.progress({type: "progress", total: f, loaded: c.loaded = 0 | g + j.size * (b.loaded / b.total)}, k, i, m))
                } : n, complete: function (d) {
                    l = !0, Q(M, function (a) {
                        c[a] = i[a]
                    }), k && (j.loaded = j.total, this.progress(j), g += j.size, c.loaded = g, a.filecomplete(d, i, k, m)), b.call(e)
                }}));
                c.abort = function (a) {
                    a || (d.length = 0), this.current = a, i.abort()
                }, i.send(h)
            })) : (a.complete(200 == c.status || 201 == c.status ? !1 : c.statusText || "error", c, a), h = !0)
        ...
        !function n(b) {
            b.image ? (j.inc(), b.toData(function (a, b) {
                f = f || (new Date).getTime() + ".png", n(b), j.next()
        ...
        return c ? (c.open("GET", a, !0), c.overrideMimeType && c.overrideMimeType("text/plain; charset=x-user-defined"), S(c, "progress", function (a) {
            ...
            if (4 == c.readyState)if (c.onreadystatechange = null, 200 == c.status) {
                ...
                d.dataURL = "data:" + d.type + ";base64," + X.encode64(c.responseBody || c.responseText), b({type: "load", result: d}, c)
            } else b({type: "error"}, c)
    ...
    X.addInfoReader(/^image/, function (a, b) {
        if (!a.__dimensions) {
            ...
            X.readAsImage(a, function (a) {
                var b = a.target;
                c.resolve("load" == a.type ? !1 : "error", {width: b.width, height: b.height}), b = null
            })
        }
    ...
    function d(b) {
        ...
        return this instanceof d ? (this.file = b, this.matrix = {sx: 0, sy: 0, sw: 0, sh: 0, dx: 0, dy: 0, dw: 0, dh: 0, resize: 0, deg: 0, quality: 1, filter: 0}, void 0) : new d(b)
    }

    var e = Math.min, f = Math.round, g = function () {
        return b.createElement("canvas")
    }, h = !1, i = {8: 270, 3: 180, 6: 90};
    try {
    ...
    d.prototype = {image: !0, constructor: d, set: function (b) {
        ...
        return"string" == typeof b && (c = b, b = a), this.set({dw: a, dh: b, resize: c})
        ...
        for (b._type = this.file.type; e(p / n, q / o) > 2;)p = 0 | p / 2 + .5, q = 0 | q / 2 + .5, f = g(), f.width = p, f.height = q, s !== b ? (v(f, s, 0, 0, s.width, s.height, 0, 0, p, q), s = f) : (s = f, v(s, b, i.sx, i.sy, i.sw, i.sh, 0, 0, p, q), i.sx = i.sy = i.sw = i.sh = 0);
        h.width = m % 180 ? o : n, h.height = m % 180 ? n : o, h.type = i.type, h.quality = i.quality, j.rotate(m * Math.PI / 180), v(h, s, i.sx, i.sy, i.sw || s.width, i.sh || s.height, 180 == m || 270 == m ? -n : 0, 90 == m || 180 == m ? -o : 0, n, o), n = h.width, o = h.height, t && a.each([].concat(t), function (b) {
            u.inc();
        ...
        return c.sw = d, c.sh = g, c.dw = h, c.dh = i, c
    }, _trans: function (a) {
        this._load(this.file, function (b, c) {
            b ? a(b) : this._apply(c, a)
        })
    }, get: function (b) {
        ...
        function h(h, i) {
            ...
            h ? k.fail() : a.each(e, function (a, e) {
                if (!k.isFail()) {
                    ...
                    if ("function" == typeof a ? a(i, g) : a.width ? g[a.preview ? "preview" : "resize"](a.width, a.height, a.type) : a.maxWidth && (i.width > a.maxWidth || i.height > a.maxHeight) && g.resize(a.maxWidth, a.maxHeight, "max"), a.crop) {
                        var h = a.crop;
                        g.crop(0 | h.x, 0 | h.y, h.w || h.width, h.h || h.height)
                    }
                    a.rotate === c && f && (a.rotate = "auto"), g.set({deg: a.rotate, type: a.type || b.type || "image/png", quality: a.quality || 1, overlay: a.overlay, filter: a.filter}), k.inc(), g.toData(function (a, b) {
    ...
    function c(b, c, d) {
        ...
        if (f) {
            if (!e.toDataURL)return a.readAsBinaryString(e, function (a) {
    ...
    e.prototype = {status: 0, statusText: "", constructor: e, getResponseHeader: function (a) {
        ...
        if (b.log("XHR._send:", e), c.cache || (j += (~j.indexOf("?") ? "&" : "?") + b.uid()), e.nodeName) {
            c.upload(c, h), g = d.createElement("div"), g.innerHTML = '<form target="' + i + '" action="' + j + '" method="POST" enctype="multipart/form-data" style="position: absolute; top: -1000px; overflow: hidden; width: 1px; height: 1px;"><iframe name="' + i + '" src="javascript:false;"></iframe><input value="' + i + '" name="callback" type="hidden"/></form>', h.xhr.abort = function () {
                var a = g.getElementsByTagName("iframe")[0];
                if (a)try {
            ...
            k.appendChild(e), b.log(k.parentNode.innerHTML), d.body.appendChild(g), h.xhr.node = g, a[i] = function (a, b, c) {
                h.readyState = 4, h.responseText = c, h.end(a, b), g = null
            }, h.readyState = 2, k.submit(), k = null
        } else {
            if (this.xhr && this.xhr.aborted)return b.log("Error: already aborted"), void 0;
            if (g = h.xhr = b.getXHR(), e.params && (j += (j.indexOf("?") < 0 ? "?" : "&") + e.params.join("&")), g.open("POST", j, !0), b.withCredentials && (g.withCredentials = "true"), c.headers && c.headers["X-Requested-With"] || g.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.each(c.headers, function (a, b) {
                ...
                g.upload && g.upload.addEventListener("progress", function (a) {
                    ...
                    if (h.status = g.status, h.statusText = g.statusText, h.readyState = g.readyState, 4 == g.readyState) {
                        ...
                        if (g.onreadystatechange = null, !g.status || g.status - 201 > 0)if (b.log("Error: " + g.status), (!g.status && !g.aborted || 500 == g.status || 416 == g.status) && ++e.retry <= c.chunkUploadRetry) {
                            ...
                            c.pause(e.file, c), b.log("X-Last-Known-Byte: " + a), e.end = a ? a : e.start - 1, setTimeout(function () {
                                h._send(c, e)
                            }, i)
                ...
                if (h.status = g.status, h.statusText = g.statusText, h.readyState = g.readyState, 4 == g.readyState) {
                    ...
                    g.onreadystatechange = null, h.end(g.status), g = null
                }
            }, b.isArray(e))if (g.setRequestHeader("Content-Type", "multipart/form-data; boundary=_" + b.expando), e = e.join("") + "--_" + b.expando + "--", g.sendAsBinary)g.sendAsBinary(e); else {
                var m = Array.prototype.map.call(e, function (a) {
                    return 255 & a.charCodeAt(0)
                });
                g.send(new Uint8Array(m).buffer)
            } else g.send(e)
        }
    }}, b.XHR = e
    ...
    var k = function (a) {
        ...
        return d.type = "image/png", d.width = c.width, d.height = c.height, d.size = 4 * c.width * c.height, d
    };
    j.Shot = k, b.Camera = j
}(window, FileAPI), function (a, b, c) {
    "use strict";
    var d = a.document, e = a.location, f = a.navigator, g = c.each, h = [];
    c.support.flash = function () {
        ...
        function m(a) {
            var b = a.wid = c.uid();
            return w._fn[b] = a, "FileAPI.Flash._fn." + b
        }

        function n(a) {
            try {
                w._fn[a.wid] = null, delete w._fn[a.wid]
            } catch (b) {
            }
        }
        ...
        function o(a, b) {
            if (!v.test(a)) {
                ...
                "//" != a.substr(0, 2) && (a = "//" + e.host + a), v.test(a) || (a = e.protocol + a)
            }
        ...
        function p(a, b, e) {
            ...
            var g, h = c.uid(), k = d.createElement("div"), l = 10;
            for (g in a)k.setAttribute(g, a[g]), k[g] = a[g];
            j(k, a), a.width = "100%", a.height = "100%", k.innerHTML = i(c.extend({id: h, src: o(c.flashImageUrl, "r=" + c.uid()), wmode: "opaque", flashvars: "scale=" + a.scale + "&callback=" + m(function p() {
                return n(p), --l > 0 && f(), !0
            })}, a)), e(!1, k), k = null
        }
        ...
        var s = c.uid(), t = 0, u = {}, v = /^https?:/i, w = {_fn: {}, init: function () {
            var a = d.body && d.body.firstChild;
            if (a)do if (1 == a.nodeType) {
                c.log("FlashAPI.state: awaiting");
                var b = d.createElement("div");
                return b.id = "_" + s, j(b, {top: 1, right: 1, width: 5, height: 5, position: "absolute", zIndex: 1e6 + ""}), a.parentNode.insertBefore(b, a), w.publish(b, s), void 0
            } while (a = a.nextSibling);
            10 > t && setTimeout(w.init, 50 * ++t)
        }, publish: function (a, b, d) {
            d = d || {}, a.innerHTML = i({id: b, src: o(c.flashUrl, "r=" + c.version), wmode: d.camera ? "" : "transparent", flashvars: "callback=" + (d.onEvent || "FileAPI.Flash.onEvent") + "&flashId=" + b + "&storeKey=" + f.userAgent.match(/\d/gi).join("") + "_" + c.version + (w.isReady || (c.pingUrl ? "&ping=" + c.pingUrl : "")) + "&timeout=" + c.flashAbortTimeout + (d.camera ? "&useCamera=" + o(c.flashWebcamUrl) : "")}, d)
        }, ready: function () {
            c.log("FlashAPI.state: ready"), w.ready = c.F, w.isReady = !0, w.patch(), c.event.on(d, "mouseover", w.mouseover), c.event.on(d, "click", function (a) {
                w.mouseover(a) && (a.preventDefault ? a.preventDefault() : a.returnValue = !0)
            })
        }, getEl: function () {
            return d.getElementById("_" + s)
            ...
            if (/input/i.test(b.nodeName) && "file" == b.type) {
                var e = b.getAttribute(s), f = w.getWrapper(b);
                if (c.multiFlash) {
                    if ("i" == e || "r" == e)return!1;
                    if ("p" != e) {
                        b.setAttribute(s, "i");
                        var g = d.createElement("div");
                        if (!f)return c.log("[err] FlashAPI.mouseover: js-fileapi-wrapper not found"), void 0;
                        j(g, {top: 0, left: 0, width: b.offsetWidth + 100, height: b.offsetHeight + 100, zIndex: 1e6 + "", position: "absolute"}), f.appendChild(g), w.publish(g, c.uid()), b.setAttribute(s, "p")
                    }
                    return!0
                }
                if (f) {
                    var h = r(f);
                    j(w.getEl(), h), w.curInp = b
                }
            } else/object|embed/i.test(b.nodeName) || j(w.getEl(), {top: 1, left: 1, width: 5, height: 5})
        }, onEvent: function (a) {
            var b = a.type;
            if ("ready" == b) {
                try {
                    w.getInput(a.flashId).setAttribute(s, "r")
                } catch (d) {
                }
                return w.ready(), setTimeout(function () {
                    w.mouseenter(a)
                }, 50), !0
            }
            "ping" === b ? c.log("(flash -> js).ping:", [a.status, a.savedStatus], a.error) : "log" === b ? c.log("(flash -> js).log:", a.target) : b in w && setTimeout(function () {
                c.log("FlashAPI.event." + a.type + ":", a), w[b](a)
            }, 1)
        }, mouseenter: function (a) {
            var b = w.getInput(a.flashId);
            if (b) {
                w.cmd(a, "multiple", null != b.getAttribute("multiple"));
                var d = [], e = {};
                g((b.getAttribute("accept") || "").split(/,\s*/), function (a) {
                    ...
                    d.push(b)
                }), w.cmd(a, "accept", d.length ? d.join(",") + "," + d.join(",").toUpperCase() : "*")
            }
        }, get: function (b) {
            return d[b] || a[b] || d.embeds[b]
        }, getInput: function (a) {
            if (!c.multiFlash)return w.curInp;
            try {
                var b = w.getWrapper(w.get(a));
                if (b)return b.getElementsByTagName("input")[0]
            } catch (d) {
                c.log('[err] Can not find "input" by flashId:', a, d)
            }
        }, select: function (a) {
            var e, f = w.getInput(a.flashId), h = c.uid(f), i = a.target.files;
            g(i, function (a) {
                c.checkFileObj(a)
            }), u[h] = i, d.createEvent ? (e = d.createEvent("Event"), e.files = i, e.initEvent("change", !0, !0), f.dispatchEvent(e)) : b ? b(f).trigger({type: "change", files: i}) : (e = d.createEventObject(), e.files = i, f.fireEvent("onchange", e))
        }, cmd: function (a, b, d, e) {
            try {
                return c.log("(js -> flash)." + b + ":", d), w.get(a.flashId || a).cmd(b, d)
            } catch (f) {
            ...
            c.flashEngine = c.support.transform = !0, k(c, {getFiles: function (a, b, d) {
                if (d)return c.filterFiles(c.getFiles(a), b, d), null;
                var e = c.isArray(a) ? a : u[c.uid(a.target || a.srcElement || a)];
                return e ? (b && (b = c.getFilesFilter(b), e = c.filter(e, function (a) {
                    return b.test(a.name)
                })), e) : this.parent.apply(this, arguments)
            }, getInfo: function (a, b) {
                if (l(a))this.parent.apply(this, arguments); else if (a.isShot)b(null, a.info = {width: a.width, height: a.height}); else {
                    if (!a.__info) {
                        var d = a.__info = c.defer();
                        w.cmd(a, "getFileInfo", {id: a.id, callback: m(function e(b, c) {
                            n(e), d.resolve(b, a.info = c)
                        })})
                    }
                    a.__info.then(b)
                }
            }}), c.support.transform = !0, c.Image && k(c.Image.prototype, {get: function (a, b) {
                this.set({scaleMode: b || "noScale"}), this.parent(a)
            }, _load: function (a, b) {
                if (c.log("FlashAPI.Image._load:", a), l(a))this.parent.apply(this, arguments); else {
                    var d = this;
                ...
                if (c.log("FlashAPI.Image._apply:", a), l(a))this.parent.apply(this, arguments); else {
                    var d = this.getMatrix(a.info), e = b;
                    w.cmd(a, "imageTransform", {id: a.id, matrix: d, callback: m(function f(g, h) {
                        c.log("FlashAPI.Image._apply.callback:", g), n(f), g ? e(g) : c.support.html5 || c.support.dataURI && !(h.length > 3e4) ? (d.filter && (e = function (a, e) {
                            a ? b(a) : c.Image.applyFilter(e, d.filter, function () {
                                b(a, this.canvas)
                            })
                        }), c.newImage("data:" + a.type + ";base64," + h, e)) : p({width: d.deg % 180 ? d.dh : d.dw, height: d.deg % 180 ? d.dw : d.dh, scale: d.scaleMode}, h, e)
                    })})
                }
            }, toData: function (a) {
                var b = this.file, d = b.info, e = this.getMatrix(d);
                l(b) ? this.parent.apply(this, arguments) : ("auto" == e.deg && (e.deg = c.Image.exifOrientation[d && d.exif && d.exif.Orientation] || 0), a.call(this, !b.info, {id: b.id, flashId: b.flashId, name: b.name, type: b.type, matrix: e}))
            }}), c.Image && k(c.Image, {fromDataURL: function (a, b, d) {
                !c.support.dataURI || a.length > 3e4 ? p(c.extend({scale: "exactFit"}, b), a.replace(/^data:[^,]+,/, ""), function (a, b) {
                    d(b)
                }) : this.parent(a, b, d)
            }}), c.Camera.fallback = function (a, b, d) {
                var e = c.uid();
                c.log("FlashAPI.Camera.publish: " + e), w.publish(a, e, c.extend(b, {camera: !0, onEvent: m(function f(a) {
                    "camera" == a.type && (n(f), a.error ? (c.log("FlashAPI.Camera.publish.error: " + a.error), d(a.error)) : (c.log("FlashAPI.Camera.publish.success: " + e), d(null)))
                })}))
            }, g(h, function (a) {
                c.Camera.fallback.apply(c.Camera, a)
            }), h = [], k(c.Camera.prototype, {_id: function () {
                return this.video.id
            }, start: function (a) {
                var b = this;
                w.cmd(this._id(), "camera.on", {callback: m(function d(e) {
                    n(d), e.error ? (c.log("FlashAPI.camera.on.error: " + e.error), a(e.error, b)) : (c.log("FlashAPI.camera.on.success: " + b._id()), b._active = !0, a(null, b))
                })})
            }, stop: function () {
                this._active = !1, w.cmd(this._id(), "camera.off")
            }, shot: function () {
                c.log("FlashAPI.Camera.shot:", this._id());
                var a = w.cmd(this._id(), "shot", {});
                return a.type = "image/png", a.flashId = this._id(), a.isShot = !0, new c.Camera.Shot(a)
            }}), k(c.Form.prototype, {toData: function (a) {
                for (var b = this.items, d = b.length; d--;)if (b[d].file && l(b[d].blob))return this.parent.apply(this, arguments);
                c.log("FlashAPI.Form.toData"), a(b)
            }}), k(c.XHR.prototype, {_send: function (a, b) {
                if (b.nodeName || b.append && c.support.html5 || c.isArray(b) && "string" == typeof b[0])return this.parent.apply(this, arguments);
                var d, e, f = {}, h = {}, i = this;
                if (g(b, function (a) {
                    a.file ? (h[a.name] = a = q(a.blob), e = a.id, d = a.flashId) : f[a.name] = a.blob
                }), e || (d = s), !d)return c.log("[err] FlashAPI._send: flashId -- undefined"), this.parent.apply(this, arguments);
                c.log("FlashAPI.XHR._send: " + d + " -> " + e, h), i.xhr = {headers: {}, abort: function () {
                    w.cmd(d, "abort", {id: e})
                ...
                var j = c.queue(function () {
                    w.cmd(d, "upload", {url: o(a.url), data: f, files: e ? h : null, headers: a.headers || {}, callback: m(function b(d) {
                        var e = d.type, f = d.result;
                        c.log("FlashAPI.upload." + e + ":", d), "progress" == e ? (d.loaded = Math.min(d.loaded, d.total), d.lengthComputable = !0, a.progress(d)) : "complete" == e ? (n(b), "string" == typeof f && (i.responseText = f.replace(/%22/g, '"').replace(/%5c/g, "\\").replace(/%26/g, "&").replace(/%25/g, "%")), i.end(d.status || 200)) : ("abort" == e || "error" == e) && (i.end(d.status || 0, d.message), n(b))
                    })})
                });
                g(h, function (a) {
        ...
        c.Camera.fallback = function () {
            h.push(arguments)
        }, c.Flash = w, c.newImage("data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==", function (a, b) {
            c.support.dataURI = !(1 != b.width || 1 != b.height), w.init()
        })
    }()
